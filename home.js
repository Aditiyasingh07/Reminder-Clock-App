...
function function2() {
  ...
  if (hours === parseInt(slotOne)) {
    image = "./img/Component 30 – 1.png"; // 6:00AM - 10:00AM
    wakeTime.innerHTML;
  } else if (hours === parseInt(slotTwo)) {
    image = "./img/goodnight_image.png"; // 10:00AM - 2:00PM
    ...
    image = "./img/lunch_image.png"; // 4:00PM - 7:00PM
    ...
    image = "./img/wake_up.png"; // 7:00PM - 5:00AM
...
function showChanges() {
  ...
  // 6:00AM - 10:00AM
  if (hour > 5 && hour < 11) {
    image = "./img/Component 30 – 1.png";
  }
  // 10:00AM - 2:00PM
  else if (hour > 10 && hour < 15) {
      image = "./img/Component 31 – 1.png";
      timeText.innerHTML = `GOOD AFTERNOON !! TAKE SOME SLEEP`;
    greetText.innerHTML = `LET'S HAVE SOME LUNCH !!`;
  } 
